 ...
 */
export const InputWithMenu: React.FC<RichInputProps> = ({menuItems, onSubmit, ...props}) => {
    ...
    return (
        <InputWithMenuContext.Provider value={{
            input, setInput, menuVisible, setMenuVisible, submit, cursor, primaryInputElement, menuInputElement
        }}>
